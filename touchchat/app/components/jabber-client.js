 ...
 */
Ext.namespace('SIMACS.xmpp');

SIMACS.xmpp.Client = Ext.extend(Ext.util.Observable, {
	...
	constructor: function(config){
		...
		SIMACS.xmpp.Client.superclass.constructor.call(this);
		
	},

	connect: function(){

		//Impostazione dei parametri di connessione al server
		oArgs = {
		...
		//Creazione del client jabber vero e proprio che permetterà la comunicazione jabberConnection il server
		this.jabberConnection = new JSJaCHttpBindingConnection(oArgs);

		//Chiamata alla funzione di inizializzazione della connessione
		...
		//Viene effettuata la connessione al server Jabber
