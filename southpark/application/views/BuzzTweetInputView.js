var BuzzTweetInputView = Backbone.View.extend({
	...
	sendTweetMessage: function(){
		...
		$.ajax({
		  type: 'POST',
		   url: 'http://www.logoslogic.com/chat/LivingRoom/southpark/twitter-php/send.php',
		  ...
		  success: function(data){
			...
			if (data.status == 'not_connected'){
				// window.location = 'http://localhost/LivingRoom/southpark/twitter/index.php';
				 window.location = 'http://www.logoslogic.com/chat/LivingRoom/southpark/twitter-php/index.php';
			}
		  },
		});
	},
