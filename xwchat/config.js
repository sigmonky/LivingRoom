...
var XC = {
  ...
  version         : '0.5', // current version of the client
  pWin            : window.opener || window, // the window which the client was opened by
  port            : 80, // default port the client will connect too
  httpbase        : '/http-bind/', // type of connection we will use, binding or polling
  timerval        : 2000, // interval between checking the connection for new information
  ...
  MUC             : 'conference.logoslogic.com', // default Group Chat Conference server
  ...
  WINOPTS         : {
                      ...
                      CONFIGURATION  : 'width=580, height=270, scrollbars=0, resizable=0, location=0, top=25',
                      HELP           : 'width=400, height=400, scrollbars=0, resizable=0, location=0, top=25',
                      MSG            : 'width=500, height=500, scrollbars=1, resizable=1, location=0, top=25',
                      MUCINVITE      : 'width=500, height=200, scrollbars=0, resizable=0, location=0, top=25',
                      MUC            : 'width=650, height=500, scrollbars=1, resizable=1, location=0, top=25',
  ...
  xc_showoffline  : 0, // show offline users
