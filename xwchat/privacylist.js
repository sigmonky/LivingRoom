...
function xcPrivacyListGetVrfy(iq) {
  ...
  JQ(iq.getDoc()).find('list').each(function() {
    ...
    html += (active == name) ? '<td align="center">Yes</td>' : '<td align="center">No</td>';
    html += (def == name) ? '<td align="center">Yes</td>' : '<td align="center">No</td>';
...
function xcPrivacyListInfoVrfy(iq) {
  ...
  JQ('#privacylist_info_title').html('Privacy List ' + name + ' Information');
...
JQ(document).ready(function() { xcPrivacyListGet(); });
